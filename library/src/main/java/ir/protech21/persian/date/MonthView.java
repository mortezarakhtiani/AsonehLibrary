...
package ir.protech21.persian.date;
...
import ir.protech21.persian.TypefaceHelper;
import ir.protech21.persian.Utils;
import ir.protech21.persian.utils.LanguageUtils;
...
public abstract class MonthView extends View {
    ...
    protected void initView() {
        ...
        mMonthTitlePaint.setTypeface(TypefaceHelper.get(getContext(),"iransans"));
        ...
        mMonthDayLabelPaint.setTextSize(Math.round(24 * (getResources().getDisplayMetrics().xdpi / DisplayMetrics.DENSITY_DEFAULT)));
        mMonthDayLabelPaint.setColor(mMonthDayTextColor);
        mMonthDayLabelPaint.setTypeface(TypefaceHelper.get(getContext(),"iransans"));
        ...
        mMonthNumPaint.setTextSize(Math.round(24 * (getResources().getDisplayMetrics().xdpi / DisplayMetrics.DENSITY_DEFAULT)));
        mMonthNumPaint.setTypeface(TypefaceHelper.get(getContext(),"iransans"));
