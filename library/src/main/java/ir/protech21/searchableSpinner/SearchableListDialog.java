package ir.protech21.searchableSpinner;
...
//        alertDialog.setTitle(strTitle);
        ...
        view.setTextSize(18);
        view.setTypeface(Typeface.createFromAsset(getActivity().getAssets(),getActivity().getString(R.string.iransans)));
        view.setPadding(16,16,16,16);
        view.setTextColor(getResources().getColor(R.color.colorgold));
        view.setText(strTitle);
        alertDialog.setCustomTitle(view);
        final AlertDialog dialog = alertDialog.create();
        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(getResources().getColor(R.color.colorBGMain)));
    ...
    private void setData(View rootView) {
        ...
        listAdapter = new ArrayAdapter(getActivity(), R.layout.simple_list_item_1, items);
