...
public class RadioButton extends TextView implements Checkable {
    ...
    public void initRadioButton(AttributeSet attrs, int defStyleAttr) {
        ...
        setBackgroundColor(Color.parseColor("#00263c"));
        Drawable d;
        if (!isInEditMode()) {
        ...
        Drawable drawable = a.getDrawable(R.styleable.RadioButton_carbon_icon);
        colorTo = a.getColor(R.styleable.RadioButton_colorTo, ContextCompat.getColor(getContext(),R.color.colorblue));
        setButtonDrawable(drawable == null ? d : drawable);
    ...
    public void setChecked(boolean checked) {
        if (mChecked != checked) {
            ...
            int colorFrom = Color.parseColor("#00263c");
            ...
            if (mOnCheckedChangeListener != null) {
                mOnCheckedChangeListener.onCheckedChanged(RadioButton.this, mChecked);
            }
