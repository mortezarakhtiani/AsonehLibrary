...
public class NavigationTabStrip2 extends View implements ViewPager.OnPageChangeListener {
    ...
    public NavigationTabStrip2(final Context context) {
        this(context, null);
    }

    public NavigationTabStrip2(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NavigationTabStrip2(final Context context, final AttributeSet attrs, final int defStyleAttr) {
    ...
    protected void onDraw(final Canvas canvas) {
        // Set bound of strip
        mStripBounds.set(
                mStripLeft - (mStripType == StripType.POINT ? mStripWeight * 0.5F : 0.0F)-20f,
                mStripGravity == StripGravity.BOTTOM ? mBounds.height() - mStripWeight : 0.0F,
                mStripRight - (mStripType == StripType.POINT ? mStripWeight * 0.5F : 0.0F)+20f,
