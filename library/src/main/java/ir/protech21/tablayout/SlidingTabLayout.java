package ir.protech21.tablayout;
...
import ir.protech21.tablayout.listener.OnTabSelectListener;
import ir.protech21.tablayout.utils.UnreadMsgUtils;
import ir.protech21.tablayout.viewpager.CustomViewPager;
import ir.protech21.tablayout.widget.MsgView;

/** 滑动TabLayout,对于ViewPager的依赖性强 */
public class SlidingTabLayout extends HorizontalScrollView implements CustomViewPager.OnPageChangeListener {
...
//        this.mViewPager.removeOnPageChangeListener(this);
    ...
    public void setViewPager(CustomViewPager vp, String[] titles) {
        if (vp == null || vp.getAdapter() == null) {
            throw new IllegalStateException("ViewPager or ViewPager adapter can not be NULL !");
        }
...
//        this.mViewPager.removeOnPageChangeListener(this);
    ...
    public void setViewPager(CustomViewPager vp, String[] titles, FragmentActivity fa, ArrayList<Fragment> fragments) {
        if (vp == null) {
